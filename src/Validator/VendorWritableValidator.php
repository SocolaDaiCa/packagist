    ...
    public function validate(mixed $value, Constraint $constraint): void
    {
        ...
        try {
            ...
            if ($vendor && $this->packageRepository->isVendorTaken($vendor, $value->getMaintainers()->first() ?: null)) {
                $this->context->buildViolation('The vendor name "'.$vendor.'" was already claimed by someone else on packagist.socoladaica.com. '
                        ...
                        . 'If those packages belong to you but were submitted by someone else, you can <a href="mailto:socoladaica@gmail.com">contact us</a> to resolve the issue.')
                    ->atPath('repository')
                    ->addViolation()
                ;
            }
